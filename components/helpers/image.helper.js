...
import { focalPointFromPromo } from "../utilities/resolveFocalPoint";

// export { default as ratiosFor } from "../utilities/ratiosFor";
...
export const getResizerParams = (
  ...
  Since this code is only supporting jpg and filterQuality of 85,
  ...
  */
  Object.keys(output).forEach((key) => {
    if (output[key]) {
      ...
      if (compressedParams) {
        output[key] = output[key].replace(":format(jpg):quality(85)", ":cm=t");
      }
    }
  });
  return output;
